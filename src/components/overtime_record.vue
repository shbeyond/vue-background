	...
	<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            <div class="modal-header">
	                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	                <h4 class="modal-title" id="myModalLabel">请输入申请描述2</h4>
	            </div>
	            <div class="modal-body">
					<textarea class="form-control" rows="3" placeholder="请输入文字" style="resize: none"></textarea>
	            </div>
	            <div class="modal-footer">
	                ...
	                <button type="button" class="btn btn-primary" data-dismiss="modal">提交申请2</button>
	            </div>
	        </div><!-- /.modal-content -->
	    </div><!-- /.modal -->
	</div>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
	                ...
	                <tr>
	                  ...
	                  <td>
	                  	<button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal2">申请</button>
	                  </td>
	                </tr>
	                <tr>
	                  <td style="width:10px">
